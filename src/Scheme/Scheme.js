...
function Scheme() {
  return (
    <main className="scheme">
      <button className="scheme__button" type="button">
        <svg className="bi bi-file-earmark-ruled-fill" xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="#bbbbbb" viewBox="0 0 16 16">
